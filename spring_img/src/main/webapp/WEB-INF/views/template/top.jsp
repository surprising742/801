...
<c:choose>
	...
	<c:otherwise>
		<c:set var="str">기본 페이지 입니다  O v O</c:set>
	</c:otherwise>
</c:choose>
<!DOCTYPE html>
<html>
...
<body>
	...
	<div class="container">
		<div class="page-header row">
			...
			<div class="col-sm-8">
				<a href="${root }"><h1>이미지 게시판<span class="glyphicon glyphicon-home"></span></h1></a>
		...
		<ul class="nav nav-tabs">
			...
			<li class="dropdown"><a class="dropdown-toggle"
				data-toggle="dropdown" href="#">이미지<span class="glyphicon glyphicon-arrow-down"></span></a>
				<ul class="dropdown-menu">
					<li><a href="${root }/read?imgno=3">이미지 조회</a></li>
					<li><a href="${root }/list">이미지 목록</a></li>
					<li><a href="${root }/create">게시판 생성</a></li>
				</ul></li>
		<c:choose>
